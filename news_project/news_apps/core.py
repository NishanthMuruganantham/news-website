...
def index():
    ...
    return render_template("index.html",home_latest_news = home_latest_news, home_india_news = home_india_news,
                        home_world_news = home_world_news, home_business_news = home_business_news,
